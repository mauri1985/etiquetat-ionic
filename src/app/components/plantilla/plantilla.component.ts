...
export class PlantillaComponent {
  ...
  constructor(private service: CategoriaService, private serviceetiqueta: EtiquetaService, private ImagenService: ImagenService, public dialog: MatDialog) {
...
refrescarPlantillas() {
  this.serviceetiqueta.listaretiqueta(true, this.Categoriaselected, this.checked, 'e').subscribe((data: Etiqueta) => this.listaetiqueta = data);

}
refrescarlienzos() {
  console.log('Lienzo');
  this.tipoimagen = 'Lienzo';
  this.ImagenService.listarImagen(true, this.Categoriaselected, this.checkedLienzo, 'Lienzo', 'e').subscribe((data) => this.listaimagenes = data);
}
refrescarlienzosImagenes() {


  this.ImagenService.listarImagen(true, this.Categoriaselected, this.checkedLienzo, 'Lienzo', 'e').subscribe((data) => this.listaimagenes = data);
  this.ImagenService.listarImagen(true, this.Categoriaselected, this.checkedLienzo, 'Imagen', 'e').subscribe((data) => this.listaimagenesObjetos = data);
...
guardar() {
  ...
  this.etiqueta.email = 'administrador@gmail.com';
  // this.objeto.id = 22;
